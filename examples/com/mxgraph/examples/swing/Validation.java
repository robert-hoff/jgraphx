...
public class Validation extends JFrame {
  ...
  public Validation() {
    ...
    multiplicities[0] = new mxMultiplicity(true, "Source", null, null, 1, "2", Arrays.asList(new String[] { "Target" }),
        "Source Must Have 1 or 2 Targets", "Source Must Connect to Target", true);
    ...
    multiplicities[2] = new mxMultiplicity(false, "Target", null, null, 1, "1",
        Arrays.asList(new String[] { "Source" }), "Target Must Have 1 Source", "Target Must Connect From Source", true);
