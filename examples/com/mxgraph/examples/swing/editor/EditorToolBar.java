...
public class EditorToolBar extends JToolBar {
  ...
  public EditorToolBar(final BasicGraphEditor editor, int orientation) {
    ...
    fonts.addAll(
        Arrays.asList(new String[] { "Helvetica", "Verdana", "Times New Roman", "Garamond", "Courier New", "-" }));
    ...
    final JComboBox sizeCombo = new JComboBox(
        new Object[] { "6pt", "8pt", "9pt", "10pt", "12pt", "14pt", "18pt", "24pt", "30pt", "36pt", "48pt", "60pt" });
