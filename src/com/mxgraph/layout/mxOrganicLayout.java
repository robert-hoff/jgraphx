    ...
    if (isOptimizeEdgeCrossing) {
      ...
      for (int j = 0; j < e.length; j++) {
        ...
        if (j != i) {
          ...
          if (iP1X != jP1X && iP1Y != jP1Y && iP1X != jP2X && iP1Y != jP2Y && iP2X != jP1X && iP2Y != jP1Y
              && iP2X != jP2X && iP2Y != jP2Y) {
            ...
            boolean intersects = Line2D.relativeCCW(iP1X, iP1Y, iP2X, iP2Y, jP1X, jP1Y) != Line2D.relativeCCW(iP1X,
                iP1Y, iP2X, iP2Y, jP2X, jP2Y)
                && Line2D.relativeCCW(jP1X, jP1Y, jP2X, jP2Y, iP1X, iP1Y) != Line2D.relativeCCW(jP1X, jP1Y, jP2X, jP2Y,
                    iP2X, iP2Y);
    ...
    if (isOptimizeEdgeDistance && isFineTuning) {
      for (int j = 0; j < v.length; j++) {
        ...
        if (e[i].source != j && e[i].target != j) {
          double distSquare = Line2D.ptSegDistSq(v[e[i].source].x, v[e[i].source].y, v[e[i].target].x, v[e[i].target].y,
              v[j].x, v[j].y);
