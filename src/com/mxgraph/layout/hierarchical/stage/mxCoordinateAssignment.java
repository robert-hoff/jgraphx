      ...
      for (int j = weightedValues[i].rankIndex - 1; j >= 0;) {
        ...
        if (weightedValue != null) {
          ...
          if (weightedValue.visited) {
            ...
            // in-between
            leftLimit = leftCell.getGeneralPurposeVariable(rankValue) + leftCell.width / 2.0 + intraCellSpacing
      ...
      for (int j = weightedValues[i].rankIndex + 1; j < weightedValues.length;) {
        ...
        if (weightedValue != null) {
          ...
          if (weightedValue.visited) {
            ...
            // cell plus any allowance for unallocated cells
            // in-between
            rightLimit = rightCell.getGeneralPurposeVariable(rankValue) - rightCell.width / 2.0 - intraCellSpacing
