        ...
        public void actionPerformed(ActionEvent e) {
          ...
          if (graphType2 == GraphType.NULL) {
            ...
            mxGraphGenerator generator = new mxGraphGenerator(
                mxGraphGenerator.getGeneratorFunction(graph, false, 0, 10), new mxDoubleValCostFunction());
            Map<String, Object> props = new HashMap<String, Object>();
            mxGraphProperties.setDirected(props, false);
            configAnalysisGraph(graph, generator, props);
      ...
      applyButton.addActionListener(new ActionListener() {
        public void actionPerformed(ActionEvent e) {
          ...
          if (startVertex == null) {
            ...
            System.out
                .println("Outdegree of " + aGraph.getGraph().getModel().getValue(startVertex) + " is " + outdegree);
            ...
            if (isCutVertex) {
              ...
              System.out
                  .println("Vertex " + aGraph.getGraph().getModel().getValue(startVertex) + " is not a cut vertex.");
            }
          }
          setVisible(false);
        }
            ...
            try {
              ...
              if ((Double) distanceMap.get(endVertex) != Double.MAX_VALUE) {
                System.out.println("The shortest distance from vertex "
                    ...
                    + (Double) costFunction.getCost(view.getState(endVertex)) + " is: " + distanceMap.get(endVertex));
              } else {
